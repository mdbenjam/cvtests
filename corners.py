...
def repeat():
    ...
    global gx, gy, grayscale, canny, blur, corners
    global p1, p2, k, lm
    ...
    elif grayscale and corners:
        corner_image = cv2.cornerHarris(frame, p1, p2, k)
        corner_image[corner_image < 0] = 0
        mx = np.max(corner_image)
        # corner_image = 255 * corner_image / mx;
        corner_image = 255 * local_max(corner_image);
